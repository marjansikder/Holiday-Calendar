...
class AppColors {
  ...
  static const Color redColor = Color(0xFFCA0000);
  static const Color blueColor = Color(0xFF1000FF);
  static const Color greenColor = Color(0xFF186004);
  static const Color orangeColor = Color(0xFFDA5208);
  static const Color purpleColor = Color(0xFFAD08DA);
  ...
  static const whiteColorE = Color(0xFFF6F8FF);
